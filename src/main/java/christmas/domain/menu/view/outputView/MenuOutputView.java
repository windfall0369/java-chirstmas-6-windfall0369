...
public class MenuOutputView {
    ...
    private static final String PREVIEW_EVENT = "12월 %d일에 우테코 식당에서 받을 이벤트 혜택 미리 보기!";
    ...
    public void printUserMenu(Map<EntireMenu, Integer> userMenu, int reservationDate) {
        System.out.printf(PREVIEW_EVENT, reservationDate);
